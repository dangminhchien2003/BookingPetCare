    ...
    <View style={styles.container}>
      {user ? (
        <>
          ...
          {/* Đặt ảnh profile bên ngoài ảnh nền */}
          <Image
            source={{
          ...
          <View style={styles.containerbutton}>
              <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('PetScreen')}>
                <Ionicons name="paw-outline" size={20} color="#fff" style={styles.icon} />
          ...
          <View style={styles.containerbutton}>
              ...
              <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('PetScreen')}>
                <Ionicons name="help-circle-outline" size={20} color="#fff" style={styles.icon} />
